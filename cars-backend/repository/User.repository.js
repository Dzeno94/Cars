...
const saveUser = (user) =>{
    ...
    return new Promise((resolve,reject)=>{
        connection.query(queryUser,[email,username,password,USER_ROLE,USER_ACTIVE],(err,result)=>{
            if(err) return reject(err);
...
const saveProfile = (user,id) =>{
    ...
    return new Promise((resolve,reject)=>{
        connection.query(queryUser,[id,firstName,lastName,address,city,phone],(err,result)=>{
            if(err) return reject(err);
           resolve(result);
        });
    });
...
const getUsers = (user) =>{
    ...
    return new Promise((resolve,reject)=>{
        connection.query(queryUser,[id,email,username,role,status],(err,result)=>{
            if(err) return reject(err);
           resolve(result);
        });
    });
